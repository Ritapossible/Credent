...
/**
 * Re-exported so the site keeps importing outcomes from the module it already
 * used, while `scripts/settlement.ts` can reach the same function without
 * pulling a browser wallet in behind it. See `outcome.ts`.
 */
